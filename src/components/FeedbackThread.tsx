    ...
    <div className="fixed inset-0 z-50 flex flex-col justify-end">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center px-6 py-12 gap-6 text-center">
          ...
          <button
            className="btn-press flex items-center gap-2 px-6 py-3.5 bg-gusring-yellow rounded-2xl font-black text-amber-900 text-sm shadow-yellow-sm w-full justify-center"
            onClick={handleOpen}
          >
